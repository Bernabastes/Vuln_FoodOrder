...
def init_database():
    ...
    # Users (with MD5 hashed passwords - VULNERABLE)
    users_data = [
    ...
    cursor.executemany('''
        INSERT INTO restaurants (owner_id, name, address, logo_path)
        VALUES (?, ?, ?, ?)
    ''', restaurants_data)
    ...
    print("   - 6 users (admin, 2 restaurant owners, 3 customers)")
    print("   - 2 restaurants (Pizza Palace, Burger House)")
    print("   - 8 menu items")
    print("   - 3 sample orders")
    print("\n🔑 Default credentials:")
    print("   - Admin: admin / admin123")
    print("   - Restaurant Owner: restaurant1 / password123")
